...
public class MStats implements CacheStatisticsMXBean {
	...
	/*
	 * have callers access fields directly for performance reasons: void countHit()
	 * { gets++; hits++; // totalGetMicros += micros; } void countMiss() { gets++;
	 * misses++; // totalGetMicros += micros; } void countPut() { puts++; //
