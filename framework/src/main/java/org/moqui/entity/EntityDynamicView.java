...
/**
 * This class is used for declaring Dynamic View Entities, to be used and thrown
 * away. A special method exists on the EntityFind to accept a EntityDynamicView
 * instead of an entityName. The methods here return a reference to itself
 * (this) for convenience.
 */
@SuppressWarnings("unused")
public interface EntityDynamicView {
	/**
	 * This optionally sets a name for the dynamic view entity. If not used will
	 * default to "DynamicView"
	 */
	...
	/**
	 * Add an alias, full detail. All parameters can be null except entityAlias and
	 * name.
	 */
