 ...
 * types.
 *
 * This class is mostly empty because it is a placeholder for use in the
 * EntityConditionFactory and most functionality is internal only.
 */
public interface EntityCondition extends Externalizable {
	...
	enum ComparisonOperator {
		EQUALS, NOT_EQUAL, LESS_THAN, GREATER_THAN, LESS_THAN_EQUAL_TO, GREATER_THAN_EQUAL_TO, IN, NOT_IN, BETWEEN, NOT_BETWEEN, LIKE, NOT_LIKE, IS_NULL, IS_NOT_NULL
	}
	...
	/**
	 * Create a map of name/value pairs representing the condition. Returns false if
	 * the condition can't be represented as simple name/value pairs ANDed together.
	 */
	boolean populateMap(Map<String, Object> map);

	/**
	 * Set this condition to ignore case in the query. This may not have an effect
