...
public interface LoggerFacade {
	/**
	 * Log level copied from org.apache.logging.log4j.spi.StandardLevel to avoid
	 * requiring that on the classpath.
	 */
	int OFF_INT = 0;
	int FATAL_INT = 100;
	int ERROR_INT = 200;
	 ...
	 *
	 * In Java or Groovy classes it is better to use SLF4J directly, with something
	 * like: <code>
	 * public class Wombat {
	 ...
	 *
	 * @param level
	 *            The logging level. Options should come from
	 *            org.apache.log4j.Level.
	 * @param message
	 *            The message text to log. If contains ${} syntax will be expanded
	 *            from the current context.
	 * @param thrown
	 *            Throwable with stack trace, etc to be logged along with the
	 *            message.
	 */
