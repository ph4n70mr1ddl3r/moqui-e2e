...
public class ConditionAlias extends ConditionField implements Externalizable {
	...
	public ConditionAlias(String entityAlias, String fieldName, EntityDefinition aliasEntityDef) {
		if (fieldName == null)
			throw new BaseArtifactException("Empty fieldName not allowed");
		if (entityAlias == null)
			throw new BaseArtifactException("Empty entityAlias not allowed");
		if (aliasEntityDef == null)
			throw new BaseArtifactException("Null aliasEntityDef not allowed");
	...
	public String getColumnName(EntityDefinition ed) {
		...
		// NOTE: this could have issues with view-entities as member entities where they
		// have functions/etc; we may
	...
	public boolean equals(Object o) {
		...
		if (fieldName != that.fieldName)
			return false;
		if (entityAlias != that.entityAlias)
			return false;
		if (aliasEntityName != that.aliasEntityName)
			return false;
		return true;
	}
