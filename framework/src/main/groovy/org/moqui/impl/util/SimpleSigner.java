...
public class SimpleSigner {
	...
	public String sign(String data) throws Exception {
		if (key == null)
			throw new BaseException("Cannot sign message, key could not be loaded from resource " + keyResource);
	...
	public static byte[] readKey(String resourcePath) throws IOException {
		...
		if (is == null)
			throw new BaseException("Could not find signing key resource " + resourcePath + " on classpath");
